...
// NSTIMER_BASED_LOOP
//
// It is a common approach to use NSTimer for scheduling rendering on the iPhone
...
#if MAIN_LOOP_TYPE == NSTIMER_BASED_LOOP
#define kThrottleFPS							2.0
#endif

#if MAIN_LOOP_TYPE == EVENT_PUMP_BASED_LOOP
...
- (void) Repaint
{
	...
	if (!_accelerometerIsActive || ([UIAccelerometer sharedAccelerometer].delegate == nil))
	{
...
#if MAIN_LOOP_TYPE == THREAD_BASED_LOOP
...
#elif MAIN_LOOP_TYPE == EVENT_PUMP_BASED_LOOP
